...
const DOCUMENT_FIELDS = [
  ...
  { formKey: "nationalIdFile", kind: "national_id" as const, stagedKey: "nationalIdOrPassportUrl", required: true },
...
export async function submitMunForm(
  ...
  const parsed = munFormSchema.safeParse({
    ...
    whyParticipate: fdStr(formData, "whyParticipate"),
    whatToLearn: fdStr(formData, "whatToLearn"),
    whySelected: fdStr(formData, "whySelected"),
    relevantSkills: fdStr(formData, "relevantSkills"),
