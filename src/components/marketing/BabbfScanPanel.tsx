...
function extractReferenceNumber(scanned: string): string {
...
export function BabbfScanPanel() {
    ...
    function tick() {
      ...
      if (video && canvas && video.readyState === video.HAVE_ENOUGH_DATA) {
        ...
        if (ctx) {
          ...
          if (code?.data) {
            stopped = true;
            router.push(`/babbf-championship-2026/ticket/${extractReferenceNumber(code.data)}`);
            return;
          }
        }
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <form
        ...
        onSubmit={(e) => {
          e.preventDefault();
          const id = manualReference.trim();
          if (id) router.push(`/babbf-championship-2026/ticket/${extractReferenceNumber(id)}`);
        }}
      >
        <input
          type="text"
          ...
          placeholder="Enter reference number (e.g. BABBF-2026-XXXXXX)"
